...
$user = $db->query('SELECT * FROM Filiados WHERE filiado_usuario = :filiado_usuario', [
...
if ($user) {
    ...
    $user = $db->query('INSERT INTO Filiados (filiado_usuario, filiado_tipo_conta, filiado_senha, filiado_nome, filiado_cpf, filiado_rg, filiado_data_nascimento, filiado_idade, filiado_empresa, filiado_cargo, filiado_situacao, filiado_telefone_residencial, filiado_celular)
 VALUES (:filiado_usuario, :filiado_tipo_conta, :filiado_senha, :filiado_nome, :filiado_cpf, :filiado_rg, :filiado_data_nascimento, :filiado_idade, :filiado_empresa, :filiado_cargo, :filiado_situacao, :filiado_telefone_residencial, :filiado_celular)', [
        'filiado_usuario' => $filiado_usuario,
